...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameStates = __webpack_require__(328);
	...
	_GameStates2.default.loading(game.state);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Gameplay = __webpack_require__(329);
	...
	exports.default = {
	  loading: function loading(game) {
	    changeState(game, _Loading2.default);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BitmapFont = __webpack_require__(331);
	
	var _BitmapFont2 = _interopRequireDefault(_BitmapFont);
	
	var _TitleCard = __webpack_require__(332);
	...
	exports.default = {
	  ...
	  titleCard: function titleCard(game) {
	    var x = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
	    var y = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
	
	    return new _TitleCard2.default(game, x, y);
	  },
	  ...
	  tetronimo: function tetronimo(game) {
	    var x = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
	    var y = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TitleCard = function (_Phaser$Group) {
	  _inherits(TitleCard, _Phaser$Group);
	
	  function TitleCard(game, x, y) {
	    _classCallCheck(this, TitleCard);
	
	    var _this = _possibleConstructorReturn(this, (TitleCard.__proto__ || Object.getPrototypeOf(TitleCard)).call(this, game));
	
	    var title = _index2.default.displayFont(game, 0, 0, 'center', _Enums2.default.GAME_TITLE);
	
	    var story = _index2.default.bodyFont(game, 0, 30, 'center', _Enums2.default.STORY);
